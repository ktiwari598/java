public class Kafka {
     ...
     * Order is guaranteed only within a partition because datas are kept in a sequence in partition
     ...
     *
     * Within a consumer group, only 1 consumer is going to be assigned to a partition
     ...
     * Consumers will read date from the broker that is leader of a partition
     *
     * Zookeeper manages Kafka Brokers
     * Zookeeper helps in leader election of brokers
     * Zookeper sends notifications to Kafka in case of changes (topic creation, deletion, brker dies, broker alive, etc)
     */
}
